"""
File: matrix.py
Author: StackOverflow and Auke Wiggers
"""
...
def inverse3D(matrix):
    """ Give the inverse of a 3d matrix """
...
def inverse2D(matrix):
    """ Give the inverse of a 2d matrix """
...
def subtract(matrix1,matrix2):
    """ Subtract two matrices of same size, elementwise """
...
def plus(matrix1, matrix2):
    """ Add two matrices of same size, elementwise """
    if len(matrix1) != len(matrix2) or len(matrix1[0]) != len(matrix2[0]):
...
def rtmatrix(rotation, translation):
    ...
    matrix = [[cos(a1) * cos(a3) - sin(a1) * cos(a2) * sin(a3), 
               -sin(a1) * cos(a3) - cos(a1) * cos(a2) * sin(a3),
               sin(a2) * sin(a3), t1 ],
              [cos(a1) * sin(a3) + sin(a1) * cos(a2) * cos(a3), 
              -sin(a1) * sin(a3) + cos(a1) * cos(a2) * cos(a3),
              -sin(a2) * cos(a3), t2 ],
              [sin(a1) * sin(a2), cos(a1) * sin(a2) , cos(a2) , t3 ],[0,0,0,1]]
    return matrix
 
def time_mult(matrix1, matrix2):
    """ Clock the time matrix multiplication takes """
    start = clock()
    new = mult(matrix1, matrix2)
    end = clock()
