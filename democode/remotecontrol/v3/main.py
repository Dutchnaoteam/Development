...
# 6) run: 
#      terminal> python main.py <InputSystem> <EventProcessFile> <NaoIPadress> [optional: <inputID>]
#           (inputID is by default '0')
# 7) enjoy :)
#
import sys
import platform
...
if (len(sys.argv) <= 3):
    ...
    sys.stdout.write( "bash> python main.py <InputSystem> <EventProcessFile> <MotionFile> <NaoIPadress> [optional: <inputID>]" + '\n')    
    sys.stdout.write( " <InputSystem>     : type of input to read, e.g. 'keyboard' or 'joystick'" + '\n')
    sys.stdout.write( " <EventProcessFile>: file name of file which process the input generated by <InputSystem>, e.g. 'keyDefault'" + '\n')
